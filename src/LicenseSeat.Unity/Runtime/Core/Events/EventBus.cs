        ...
        public void Emit(string eventName, object? data = null)
        {
            ...
            foreach (var subscription in handlers)
            {
                ...
                catch (Exception)
                {
                    ...
                    UnityEngine.Debug.LogWarning($"[LicenseSeat SDK] An event handler failed for {eventName}.");
#else
                    System.Diagnostics.Debug.WriteLine($"[LicenseSeat SDK] An event handler failed for {eventName}.");
#endif
                }
            }
        }
