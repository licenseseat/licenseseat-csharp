...
namespace LicenseSeat
{
    ...
    public class CryptoException : LicenseSeatException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoException"/> class with an error code and inner exception.
        /// </summary>
        /// <param name="message">The error message.</param>
        /// <param name="errorCode">The stable cryptographic error code.</param>
        /// <param name="innerException">The underlying exception.</param>
        public CryptoException(string message, string errorCode, Exception innerException)
            : base(message, errorCode, innerException)
        {
        }
